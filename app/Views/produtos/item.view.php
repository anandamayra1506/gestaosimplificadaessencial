            ...
            <div class="card card-primary">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="quantidade" id="inputQuantidade"
                            placeholder="Quantidade do produto" value="<?= value($quantidade) ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <?php component(\Components\Select::class)
                            ...
                            ->addOption('Kit', 'Kit')
                            ->addOption('Metro', 'Metro')
                            ->addOption('Centimetro', 'Centimetro')
                            ->addOption('Kilo', 'Kilo')
